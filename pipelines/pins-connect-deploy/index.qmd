...
We are using the smaller `laxflights2022` data set described on the [data preparation](../../data-prep.qmd) page. The data set has been uploaded to pins, as described on the [data pins](../../data-pins.qmd) page. This is meant to simulate this workflow where we stay inside Connect as much as possible.
