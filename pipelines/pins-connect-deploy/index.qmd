---
title: Posit Connect, Pins Input, Native Endpoint
...
# pak::pak(c("tidymodels", "embed", "vetiver", "pins", "rsconnect", 
# "doParallel", "lme4", "xgboost", "plumber", "cpp11", "dqrng", "RcppEigen",
# "RcppProgress", "testthat", "BH", "sitmo"))
library(tidymodels)
library(embed)
library(vetiver)
library(pins)
...
## Getting set up on Posit Connect
...
We are using a dataset stored in pin, simulating a workflow where we stay inside Connect as much as possible. The [data preparation](../../data-prep.qmd) page describes how we prepared the data set and the [data pins](../../data-pins.qmd#posit-connect) page describes how we uploaded it to pins. Do those steps first and then read your own pin instead of `"emil.hvitfeldt/laxflights2022_lite"`.
